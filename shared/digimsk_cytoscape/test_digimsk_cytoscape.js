/** Unit checks for shared DigiMskCy presentation kernel (Node). */
const path = require("path");
const assert = require("assert");

const DigiMskCy = require(path.join(__dirname, "digimsk_cytoscape.js"));

const short = DigiMskCy.nodeMetrics("Condition", "Fracture");
const long = DigiMskCy.nodeMetrics(
  "Condition",
...
const prepared = DigiMskCy.prepareElements([
...
const els = DigiMskCy.toElements({
...
const style = DigiMskCy.cytoscapeStyle();
...
console.log("digimsk_cytoscape tests OK");
