...
| **6** | Three-card **Vertex** pilot against DigiMSK on port 8001; fix dumping / jargon / invention | Bot running |
| **7** | LLM-draft remaining cards from sampled stems; clinician + lay edit; **lock** | After pilot |
| **8** | Generate frozen transcripts (patient agent ↔ DigiMSK); auto-gates; freeze | After cards lock |
