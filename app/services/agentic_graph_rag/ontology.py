...
def render_ontology_card(ontology: RedFlagOntology | None = None) -> str:
    ...
    lines.append("")
    lines.append("SERIOUS CONDITIONS (only these may be raised as suspicion):")
    ...
    lines.append("")
    if ont.mediators:
        lines.append("CONCEPTUAL GATEWAYS (mediators linking background risk to a condition):")
