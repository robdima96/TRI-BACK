...
class AgentTrace(BaseModel):
    ...
    # Ground-truth deterministic ranking captured at run start (anchor for review).
    deterministic_conditions: list[str] = Field(default_factory=list)
    ...
    def compact(self) -> dict[str, Any]:
        ...
        return {
            ...
            "deterministic_conditions": self.deterministic_conditions,
            "steps": [
                {
                    "step": s.step,
                    "thought": s.thought,
