...
def run_disposition_agent(
    *,
    ...
    trace = AgentTrace(
        ...
        touched_conditions=list(touched_conditions),
    )
    ...
    ctx = ToolContext(
        ...
        ontology=ontology,
        query=query,
        precomputed_matched_factors=list(matched_factors),
        precomputed_factor_matches=precomputed_factor_matches,
    )
    ...
    messages.append(
        {
            ...
            "content": (
                ...
                + (
                    "Begin. Inspect grounded graph/RAG evidence with tools, then "
                    "reason, then return your final_answer."
                    if graph_enabled
                    else "Begin. Inspect grounded RAG evidence with tools, then "
                    "reason, then return your final_answer."
                )
            ),
        }
