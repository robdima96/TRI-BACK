/**
 * TRI-BACK shared Cytoscape presentation kernel.
 *
 ...
 *
 * Source of truth: shared/tri_back_cytoscape/tri_back_cytoscape.js
 * Sync copies into study assets + Graphs/app public via scripts/sync_tri_back_cytoscape.py
 *
 * Global: window.TriBackCy (alias window.DigiMskCy)
 */
(function (global) {
  "use strict";
  ...
  function cytoscapeStyle(opts) {
    ...
    return [
      ...
      {
        selector: "edge[confirmAgainst = true]",
        style: {
          "line-style": "dashed",
          "line-color": "#7c3aed",
