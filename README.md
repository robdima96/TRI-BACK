...
| **Study prototype** | [`prototypes/digimsk_study_app/`](prototypes/digimsk_study_app/) | Reflex UI for the research study (login, arms, admin) |
...
2. Start the **study prototype** (see `prototypes/digimsk_study_app/readme.txt`) — UI **3000**
