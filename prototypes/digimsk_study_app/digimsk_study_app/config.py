...
# Session JSON is owned by the chatbot (`bot/data/sessions`), not the study UI.

_SESSIONS = _ROOT.parents[1] / "bot" / "data" / "sessions"
...
SESSIONS_DIR = Path(_env_str("DIGIMSK_SESSIONS_DIR", str(_SESSIONS)))
