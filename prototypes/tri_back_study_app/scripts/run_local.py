#!/usr/bin/env python3
"""Launch the TRI-BACK study UI locally.
...
Local-only: does not set TRI_BACK_PUBLIC_ACCESS or change Cloud Run entrypoints.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Launch the local TRI-BACK study UI")
    parser.add_argument(
        "--kill-stale",
        action="store_true",
