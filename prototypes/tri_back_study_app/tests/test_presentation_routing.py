...
from tri_back_study_app.adapters.presentation import (
    PresentationAdapter,
    get_presentation_adapter,
    simplify_disposition,
)
from tri_back_study_app.graph import BotTraversalClient, reasoning_text
from tri_back_study_app.graph.schemas import GraphTraversalTrace, TraversalStep, ConditionTraversal
...
def test_arm2_gets_reasoning_not_graph(monkeypatch):
    ...
    monkeypatch.setattr(
        "tri_back_study_app.adapters.presentation.call_chat_api",
        fake_chat,
    )
